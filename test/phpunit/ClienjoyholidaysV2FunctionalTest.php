...
/**
 * \file    test/phpunit/ClienjoyholidaysV2FunctionalTest.php
...
/**
 * Class ClienjoyholidaysV2FunctionalTest
 *
 ...
 *
 * @package Testclienjoyholidaysv2
 */
class ClienjoyholidaysV2FunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modClienjoyholidaysV2')->click();
		} else {
			// Disable the module
			$this->byHref('modClienjoyholidaysV2')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/clienjoyholidaysv2/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('clienjoyholidaysv2/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/clienjoyholidaysv2/admin/about.php');
		$this->authenticate();
		return $this->assertContains('clienjoyholidaysv2/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('clienjoyholidaysv2widget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modClienjoyholidaysV2_ClienjoyholidaysV2Triggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modClienjoyholidaysV2_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
